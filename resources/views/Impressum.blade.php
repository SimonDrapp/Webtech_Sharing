...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        <title>my-easysharing | Impressum </title>
    </head>

    <body>
        @include('includes.header')

        <h1 id="ImpressumUeberschrift">Impressum & Datenschutz</h1>

        <h3 class="ImpressumTeilüberschrift">Haftungsausschluss:</h3>


        <h5 class="ImpressumTeilüberschrift1"><b>Haftung für Inhalte</b></h5>
        <p class="ImpressumText">Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und Aktualität der Inhalte können wir jedoch keine Gewähr übernehmen.
        ...
        <h5 class="ImpressumTeilüberschrift"><b>Haftung für Links</b></h5>
        <p class="ImpressumText">Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben.
        ...
        <h5 class="ImpressumTeilüberschrift"><b>Urheberrecht</b></h5>
        <p class="ImpressumText">Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht.
        ...
        <h5 class="ImpressumTeilüberschrift"><b>Datenschutz</b></h5>
        <p class="ImpressumText">Die Nutzung unserer Webseite ist in der Regel ohne Angabe personenbezogener Daten möglich.
